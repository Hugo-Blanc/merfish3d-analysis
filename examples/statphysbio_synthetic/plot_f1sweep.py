...
if __name__ == "__main__":
    f1_sweep_path = Path(r"/home/hblanc01/Data/sparse_16bit_example/sim_acquisition_spotiflow_synth_3D_grid_1/decode_params_results_spotiflow_synth_3D_grid_1.json")
